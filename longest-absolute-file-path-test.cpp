...
TEST(
    ...
    Test_dir__subdir1___file1_ext___subsubdir1__subdir2___subsubdir2____file2_ext) {
  string input =
      "dir\n\tsubdir1\n\t\tfile1."
      "ext\n\t\tsubsubdir1\n\tsubdir2\n\t\tsubsubdir2\n\t\t\tfile2.ext";
  int expected_int = 32;
...
TEST(LongestAbsoluteFilePath,
     Test_a__aa___aaa____file1_txt_aaaaaaaaaaaaaaaaaaaaa__sth_png) {
  string input =
