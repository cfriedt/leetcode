...
public:
  ...
  int rand10() {
    ...
    // --------
    //
    // Best case scenario: O(1) (takes exactly 2 iterations, with zero
    // rejections). Worst case scenario: O(inf) (even though its statistically
    // unlikely, it's
    //                              still possible to have numbers that add up
    //                              to greater than 10).
    //
