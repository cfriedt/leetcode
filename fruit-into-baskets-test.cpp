...
TEST(FruitIntoBaskets, Test_big) {
  vector<int> tree({1,  68, 1,  4,  4,  4,  4,  71, 85, 71, 71, 71, 98, 98, 71,
                    71, 15, 2,  49, 49, 49, 13, 49, 49, 49, 49, 13, 17, 17, 48,
                    48, 17, 17, 17, 17, 90, 0,  0,  90, 90, 90, 0,  0,  0,  90,
                    0,  7,  89, 7,  7,  42, 91, 91, 91, 42, 91, 59, 59, 87, 59,
                    59, 91, 59, 42, 42, 59, 42, 42, 59, 42, 59, 42, 42, 42, 42,
                    89, 1,  1,  1,  62, 1,  65, 1,  1,  1,  1,  1,  1,  42, 40,
                    96, 0,  96, 36, 36, 96, 36, 36, 96, 98});
  int expected_int = 13;
  int actual_int = Solution().totalFruit(tree);
  EXPECT_EQ(actual_int, expected_int);
}

TEST(FruitIntoBaskets, Test_40kZeros) {
  vector<int> tree(
