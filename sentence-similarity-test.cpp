...
TEST(
    SentenceSimilarity,
    Test_great_acting_skills__fine_drama_talent__great_fine_acting_drama_skills_talent) {
...
TEST(
    SentenceSimilarity,
    Test_great_acting_cowboy_pilot__fine_drama_talent_astronaut__great_fine_acting_drama_skills_talent) {
  vector<string> words1{"great", "acting", "cowboy"};
  vector<string> words2{"fine", "drama", "talent"};
  vector<vector<string>> pairs{{"great", "fine"},
                               {"acting", "drama"},
                               {"skills", "talent"},
                               {"cowboy", "rancher"}};
  bool expected_bool = false;
...
TEST(
    SentenceSimilarity,
    Test_great_acting_skills_pilot__fine_drama_talent_astronaut__great_fine_acting_drama_skills_talent) {
