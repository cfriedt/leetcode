...
TEST(
    ...
    Test_babbbbaabbababbaaaaababbaaabbbbaaabbbababbbbabaabababaabaaabbbabababbbabababaababaaaaabbabaaaabaaaab) {
  string s = "babbbbaabbababbaaaaababbaaabbbbaaabbbababbbbabaabababaabaaabbbaba"
             "babbbabababaababaaaaabbabaaaabaaaab";
  int expected_int = 81;
  int actual_int = Solution().longestPalindromeSubseq(s);
  EXPECT_EQ(actual_int, expected_int);
}
